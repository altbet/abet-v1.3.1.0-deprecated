...
*Setup instructions for a gitian build of Altbet using a Debian VM or physical system.*
...
- [Building Altbet](#building-altbet)
...
Clone the git repositories for altbet and gitian and then checkout the altbet version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/altbet-crypto/altbet.git
cd altbet
...
Follow the instructions in [doc/release-process.md](release-process.md) in the altbet repository
...
To build Altbet (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the altbet repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/altbet/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/altbet-crypto/altbet
...
For example:
```bash
URL=https://github.com/crowning-/altbet.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/altbet-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/altbet-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/altbet-build.assert
```
...
[altbet/gitian.sigs](https://github.com/altbet-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
