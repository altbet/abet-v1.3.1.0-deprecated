...
In order to support loading of multiple wallets in altbet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is altbet.cpp.
...
Changes to altbet.cpp
----------------------
altbet.cpp is the entry point into altbet-qt, and as such, will require some minor modifications to provide hooks for
