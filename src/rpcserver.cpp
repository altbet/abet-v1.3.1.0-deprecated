...
#ifdef ENABLE_WALLET
        {"altbet", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use altbetd, or the -server option to altbet-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
